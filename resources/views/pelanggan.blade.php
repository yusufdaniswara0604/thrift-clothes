...
  
    ...
    <div class="flex-1 min-h-screen bg-gray-100">
      ...
      <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 14">
        ...
        <div class="p-8">
            ...
            <h1 class="mb-5 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Pelanggan</h1>

            <div class="max-w-4xl mx-auto bg-purple-100 rounded-lg shadow-lg overflow-hidden mt-8">
    <div class="p-6 md:p-8">
        <h2 class="text-2xl md:text-3xl font-bold mb-6">Daftar Pelanggan</h2>
        <ul class="divide-y divide-gray-200">
            <li class="flex items-center py-4">
                ...
                <div class="ml-3">
                    <h3 class="text-lg font-medium">Ragil Setiawan</h3>
                    <p class="text-gray-500">@ragilss</p>
                </div>
  ...
  <path fill="currentColor" fill-rule="evenodd" d="M3 8a5 5 0 0 1 5-5h8a5 5 0 0 1 5 5v8a5 5 0 0 1-5 5H8a5 5 0 0 1-5-5V8Zm5-3a3 3 0 0 0-3 3v8a3 3 0 0 0 3 3h8a3 3 0 0 0 3-3V8a3 3 0 0 0-3-3H8Zm7.597 2.214a1 1 0 0 1 1-1h.01a1 1 0 1 1 0 2h-.01a1 1 0 0 1-1-1ZM12 9a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm-5 3a5 5 0 1 1 10 0 5 5 0 0 1-10 0Z" clip-rule="evenodd"/>
            ...
            <li class="flex items-center py-4">
                ...
                <div class="ml-3">
                    <h3 class="text-lg font-medium">Jessica Jane</h3>
                    <p class="text-gray-500">@jesicajane</p>
                </div>
                <div class="ml-auto flex items-center">
                    <a href="#" class="text-blue-500 hover:text-blue-600">Instagram</a>
                    <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
  <path fill="currentColor" fill-rule="evenodd" d="M3 8a5 5 0 0 1 5-5h8a5 5 0 0 1 5 5v8a5 5 0 0 1-5 5H8a5 5 0 0 1-5-5V8Zm5-3a3 3 0 0 0-3 3v8a3 3 0 0 0 3 3h8a3 3 0 0 0 3-3V8a3 3 0 0 0-3-3H8Zm7.597 2.214a1 1 0 0 1 1-1h.01a1 1 0 1 1 0 2h-.01a1 1 0 0 1-1-1ZM12 9a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm-5 3a5 5 0 1 1 10 0 5 5 0 0 1-10 0Z" clip-rule="evenodd"/>
            ...
            <li class="flex items-center py-4">
                ...
                <div class="ml-3">
                    <h3 class="text-lg font-medium">Michael Brown</h3>
                    <p class="text-gray-500">@michaelbrown</p>
                </div>
                <div class="ml-auto flex items-center">
                    <a href="#" class="text-blue-500 hover:text-blue-600">Instagram</a>
                    <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
