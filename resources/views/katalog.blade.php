    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
      ...
      <div class="border border-gray-200 rounded-lg overflow-hidden">
        ...
        <div class="p-4 bg-purple-200">
          ...
          <a href="/detailbarang" style="background-color: #540081; color: white; padding: 0.5rem 1rem; border-radius: 0.25rem;">DETAIL</a>
          <a href="/checkout" style="background-color: #A600FF; color: white; padding: 0.5rem 1rem; border-radius: 0.25rem;">PESAN</a>
          </div>
        </div>
      </div>
